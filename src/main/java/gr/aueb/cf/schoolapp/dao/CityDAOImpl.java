...
public class CityDAOImpl implements ICityDAO {
    ...
    public Optional<List<City>> getByCityName(String name) throws CityDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            throw new CityDAOException("SQL Error while retrieving cities by name: " + name);
        }
    ...
    public City getById(int id) throws CityDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            throw new CityDAOException("SQL Error while retrieving city with ID: " + id);
        }
        return city;
    }
    ...
    public City insert(City city) throws CityDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            throw new CityDAOException("SQL Error in City insertion");
        }
        return city;
    }
    ...
    public City update(City city) throws CityDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            DBUtil.rollbackTransaction();
            throw new CityDAOException("SQL Error in City update");
        }
    }
    ...
    public void delete(int id) throws CityDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            DBUtil.rollbackTransaction();
            throw new CityDAOException("SQL Error in City deletion with ID: " + id);
        }
    }
    ...
    public List<City> getAllCities() throws CityDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            throw new CityDAOException("SQL Error while retrieving all cities");
        }
